            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // check if node with this ID exists already    * use "const" and "&" for avoiding changing and delete to unique_ptr
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        {
                            // get iterator on incoming and outgoing node via ID search    * here were "const"and "&" used, because of "no change" and "no delete" for unique_ptr
